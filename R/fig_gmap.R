...
#' @param zoom initial \href{https://developers.google.com/maps/documentation/maps-static/start#Zoomlevels}{zoom level} to use when displaying the map
#' @param api_key Google Maps \href{https://developers.google.com/maps/documentation/javascript/get-api-key}{API key}
#' @param map_type \href{https://developers.google.com/maps/documentation/maps-static/start#MapTypes}{map type} to use for the plot - one of "hybrid", "satellite", "roadmap", "terrain"
