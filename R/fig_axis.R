...
#'  (\href{https://docs.bokeh.org/en/latest/docs/reference/models/formatters.html#bokeh.models.formatters.BasicTickFormatter}{"basic"},
#'  \href{https://docs.bokeh.org/en/latest/docs/reference/models/formatters.html#bokeh.models.formatters.NumeralTickFormatter}{"numeral"},
#'  or \href{https://docs.bokeh.org/en/latest/docs/reference/models/formatters.html#bokeh.models.formatters.PrintfTickFormatter}{"printf"});
...
#' When \code{number_formatter} is "basic" and the axis type is datetime, \code{format} specifies how to display tick values from a continuous range as formatted datetimes. See \href{https://docs.bokeh.org/en/latest/docs/reference/models/formatters.html#bokeh.models.formatters.DatetimeTickFormatter}{DatetimeTickFormatter}
#' When \code{number_formatter} is "numeral", \code{format} specifies a human-readable format string. See \href{https://docs.bokeh.org/en/latest/docs/reference/models/formatters.html#bokeh.models.formatters.NumeralTickFormatter}{NumeralTickFormatter}.
#' When \code{number_formatter} is "printf", \code{format} is a printf-style format string. See \href{https://docs.bokeh.org/en/latest/docs/reference/models/formatters.html#bokeh.models.formatters.PrintfTickFormatter}{PrintfTickFormatter}.
#' @family axes
